...
class Works extends Component{
    constructor(props){
        ...
        this.objs = [
            new PortfolioObject('Mind Over Melee Radio','https://store.steampowered.com/app/1335020/Mind_Over_Melee_Radio/', null, 'A game made in unity that creates proccedurally generated levels and soundtracks',['Unity 3D','C#','Node.js','MySQL', 'JavaScript','PHP','Steamworks']),
            new PortfolioObject('Unlock The Box','https://unlockthebox.io',null,'Collaborated with classmates to create a web app version of board game "Unlock The Box"',['Node.js','React','AWS','Postgres']),
